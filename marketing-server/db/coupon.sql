...
#     voucher_type         tinyint     default 0                      not null comment '券类型',
    outer_name           varchar(64)    default ''                  not null comment '展示名称（用户侧）',
...
(
    ...
    expand_json    json                                       null comment '扩展属性：x天可用、封顶金额、指定品类/商品',
...
(
    id            bigint unsigned primary key auto_increment not null comment 'id',
    coupon_id     bigint      default 0                      not null comment '券id',
    coupon_code   varchar(32) default ''                     not null comment '券码',
    user_id       bigint      default 0                      not null comment '用户id',
    use_status    tinyint     default 0                      not null comment '使用状态 0 未使用 1 已使用 2 已转赠 3 已过期',
